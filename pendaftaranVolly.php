...
body {
  ...
  padding: 20px;
  background-image: url('assets/images/BG_1.png'); /* Ganti dengan path ke gambar Anda */
...
@media screen and (max-width: 500px) {
  ...
  <!-- ---------------------------- -->
  <section class="formss">
      <h3 class="titleform">Pemain 6</h3>
      <div class="form">
  ...
  <!-- ---------------------------- -->
  <section class="formss">
    <h3 class="titleform">Pemain Cadangan 1</h3>
    <div class="form">
...
<!-- ---------------------------- -->
<section class="formss">
    <h3 class="titleform">Pemain Cadangan 2</h3>
    <div class="form">
...
<!-- ---------------------------- -->
<section class="formss">
    <h3 class="titleform">Pemain Cadangan 3</h3>
    <div class="form">
...
<!-- ---------------------------- -->
<section class="formss">
    <h3 class="titleform">Pemain Cadangan 4</h3>
    <div class="form">
...
<!-- ---------------------------- -->
<section class="formss">
    <h3 class="titleform">Pemain Cadangan 5</h3>
    <div class="form">
...
<!-- ---------------------------- -->
<section class="formss">
    <h3 class="titleform">Pemain Cadangan 6</h3>
    <div class="form">
...
<!-- ---------------------------- -->
<section class="formss">
    <h3 class="titleform">Pemain Cadangan 7</h3>
    <div class="form">
...
<!-- ---------------------------- -->
<section class="formss">
    <h3 class="titleform">Pemain Cadangan 8</h3>
    <div class="form">
